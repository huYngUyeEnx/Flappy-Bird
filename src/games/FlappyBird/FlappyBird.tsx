      ...
      >
        ...
        >
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="flex justify-around flex-1 h-20 items-start"
            >
        ...
        {!gameStarted && !gameOver && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/20 z-50 text-center">
            <p className="text-white text-3xl font-bold mb-4 drop-shadow-lg uppercase tracking-widest">
              FlFlappyBirdy Bird
            </p>
        ...
        {/* Màn hình Thua cuộc */}
        {gameOver && <GameOver score={score} onRestart={handleAction} />}
